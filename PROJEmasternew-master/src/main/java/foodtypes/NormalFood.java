...
public class NormalFood extends OrderingFood {
public NormalFood(){
    ...
    public void foodName() {
        ...
        System.out.println("Choose your food type ( keskek / chichken and rice  / sarma / kebab / soup):");
        String food1 = scanner.nextLine().toLowerCase();
        while (true) {
            if (food1.equals("keskek") || food1.equals("chichken and rice") ||
