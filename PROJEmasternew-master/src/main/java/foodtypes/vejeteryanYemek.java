...
public class vejeteryanYemek extends SadeceYemekSiparişiVermek {
public vejeteryanYemek(){
    ...
    public void yemekadı() {
        ...
        System.out.println("Lütfen yemek tercihi yapınız ( pırasa / karnabahar  / sarma / makarna salatası / çorba ):");
        String yemek1 = scanner.nextLine().toLowerCase();
        while (true) {
            if (yemek1.equals("pırasa") || yemek1.equals(" karnabahar ") ||
        ...
        while (true) {
            try {
                ...
                if (dessertPreference) {
                    while (true) {
                        System.out.println("Tatlı seçiniz ( creampuff / cake / tiramisu / spoonful )");
