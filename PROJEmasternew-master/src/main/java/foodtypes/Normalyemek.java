...
public class Normalyemek extends SadeceYemekSiparişiVermek {
public Normalyemek(){
    ...
    public void yemekadı() {
        ...
        System.out.println("Lütfen yemek tercihi yapınız ( keşkek / tavuk pilav  / sarma / makarna salatası / çorba ):");
        String yemek1 = scanner.nextLine().toLowerCase();
        while (true) {
            if (yemek1.equals("keşkek") || yemek1.equals("tavuk pilav") ||
