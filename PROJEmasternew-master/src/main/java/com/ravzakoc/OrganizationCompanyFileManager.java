...
import static com.ravzakoc.OrganizasyonSirketiMemory.sirket;

public class OrganizationCompanyFileManager {

    private static final String DOSYA_YOLU = "PROJEmasternew-master/src/main/java/com/ravzakoc/organizasyon_sirketleri.txt";
