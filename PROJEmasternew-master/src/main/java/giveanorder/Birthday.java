...
public class Birthday extends OrderOrganisation {
    public Birthday(){
    }
    ...
    public void waiterPreference() {
        ...
        while (true) {
            System.out.println("Do you want a waitress? (True / False )");
    ...
    public void dj() {
        ...
        while (true) {
            System.out.println("Do you want a DJ? (True / False )");
